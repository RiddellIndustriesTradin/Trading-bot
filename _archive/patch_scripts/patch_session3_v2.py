#!/usr/bin/env python3
"""
Session 3 patch v2: fix three bugs in close-path bookkeeping.

v2 fix: the "blank" lines inside docstrings and try blocks in kraken_api.py
have leading whitespace (8 spaces), not truly empty. Patches updated to match.
...
#
# Reduced match scope: only target the 3 lines we know exactly,
# avoiding the docstring whitespace ambiguity.
# ============================================================
kraken_edits = [
    (
        '        try:\n'
...
# ============================================================
print("Session 3 patch script v2")
print("=" * 60)
